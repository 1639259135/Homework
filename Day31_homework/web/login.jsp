    ...
    <div style="background-color:#d6eaff;
        ...
        <form action="login" method="post">
            <input style="left: 50px;top: 150px;" placeholder="请输入网易云邮箱账号"
                type="text" id="username" name="username" onfocus="inputFocus(this)" onblur="inputBlur(this)"
            ...
            <input placeholder="请输入密码" style="left: 50px;top: 230px;"
                type="password" id="password" name="password" onfocus="inputFocus(this)" onblur="inputBlur(this)">
        ...
        <div style="position:absolute;left: 380px;top: 450px;">忘记密码?</div>
    </div>
